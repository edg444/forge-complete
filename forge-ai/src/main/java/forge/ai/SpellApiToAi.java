...
public enum SpellApiToAi {
    ...
    private final Map<ApiType, Class<? extends SpellAbilityAi>> apiToClass = Maps.newEnumMap(ImmutableMap
            ...
            .put(ApiType.ChangeNumber, AlwaysPlayAi.class)
            ...
            .put(ApiType.SetExpansion, AlwaysPlayAi.class)
            .put(ApiType.AskFact, AlwaysPlayAi.class)
            .put(ApiType.ChooseEyeColor, AlwaysPlayAi.class)
            ...
            .put(ApiType.ExchangeZoneAll, AlwaysPlayAi.class)
            ...
            .put(ApiType.Augment, AugmentAi.class)
            .put(ApiType.AnimateLibrary, AnimateLibraryAi.class)
            ...
            .put(ApiType.SevenQuestions, GuessArtistAi.class)
