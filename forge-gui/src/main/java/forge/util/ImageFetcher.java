    ...
    public void fetchImage(final String imageKey, final Callback callback) {
        ...
        if (prefix.equals(ImageKeys.CARD_PREFIX)) {
            ...
            if (tempdata.length > 2) {
                ...
                String cdnUrl = CdnUuidCache.getCdnUrlIfCached(tokenCode, tempdata[2], langCode, face, "normal");
                if (cdnUrl != null) downloadUrls.add(cdnUrl);
                ...
                while (it.hasNext()) {
                    ...
                    String cdnUrl = CdnUuidCache.getCdnUrlIfCached(tokenCode, tis.collectorNumber(), langCode, face, "normal");
                    if (cdnUrl != null) downloadUrls.add(cdnUrl);
