...
public enum TrackableProperty {
    ...
    Rotate180(TrackableTypes.BooleanType),
    Signed(TrackableTypes.BooleanType),
    InfiniteColorless(TrackableTypes.BooleanType),
    HasOnOffSwitch(TrackableTypes.BooleanType),
    ...
    Split3State(TrackableTypes.CardStateViewType, FreezeMode.IgnoresFreeze),
    Split4State(TrackableTypes.CardStateViewType, FreezeMode.IgnoresFreeze),
    Split5State(TrackableTypes.CardStateViewType, FreezeMode.IgnoresFreeze),
