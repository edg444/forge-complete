...
public enum ApiType {
    ...
    ExchangeZoneAll (ZoneExchangeAllEffect.class),
    ...
    RememberNumber (RememberNumberEffect.class),
    QueueNextGameReturn (QueueNextGameReturnEffect.class),
    SignCard (SignCardEffect.class),
    ToggleSwitch (ToggleSwitchEffect.class),
    ChooseExpansion (ChooseExpansionEffect.class),
    OpenBooster (OpenBoosterEffect.class),
    DistributeKeywords (DistributeKeywordsEffect.class),
    SwapLibraryWithDeck (SwapLibraryWithDeckEffect.class),
    DrawFromOutsideGame (DrawFromOutsideGameEffect.class),
    ...
    SevenQuestions (SevenQuestionsEffect.class),
